...
class KassaCardUpdateTestCase(APITestCase):
    def setUp(self):
        ...
        self.order_card = MemberCard.objects.create(card_number=222222222, registered=timezone.now())
        self.blank_card = MemberCard.objects.create(card_number=333333333)
