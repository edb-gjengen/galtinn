...
def show_app_download(context):
    ...
    app_resources = {
        'android': {
            ...
            'app_image': static('dist/images/google_play_{}_badge_web_generic.png'.format(language_code)),
        },
        'ios': {
            'app_url': 'https://itunes.apple.com/us/app/chateau-neuf/id1262532938?ls=1&mt=8',
            'app_image': static('dist/images/app_store_badge_{}.svg'.format(language_code)),
        },
    }
    os = 'unknown'
