...
from dusken.views.membership import (MembershipRegisterView, MembershipPurchaseView, MembershipListView,
...
urlpatterns = [
    ...
    url(r'^membership/register/$', MembershipRegisterView.as_view(), name='membership-register'),
