...
from apps.tekstmelding.models import (TekstmeldingEvent, IncomingMessage, OutgoingMessage, OutgoingResponse,
                                      DeliveryReport)
...
class OutgoingMessageAdmin(admin.ModelAdmin):
    ...
    list_display = ['pk', 'sender', 'pricegroup', 'content_type_id', 'destination', 'content', 'timestamp',
                    'show_incoming_link']
